...
│
│
├── sync_service                   # dvc сервис 
│  ├── Dockerfile                  # докерфайл сервиса синхронизации историчности датасетов
│  ├── entrypoint.sh               # скрипт для регулярного сканирования s3 и пушей на гит
│  ├── s3_connector.py             # модуль подключения к s3
│  └── sync_with_s3.py             # основной модуль обновления
│
